    ...
    >
      <Group>
        ...
        <Stack gap={'1'} pl={'md'} miw={rem(90)}>
          <Text fw={400} c={'dimmed'}>
            {t('transportation.flight_number', 'Flight #')}
          </Text>
        ...
        <Stack gap={'1'} pl={'md'} miw={rem(150)}>
          <Text fw={400} c={'dimmed'}>
            {t('transportation.confirmation_code', 'Confirmation Code')}
          </Text>
      ...
      <Attachments
        ...
        onDelete={(attachmentName) =>
          deleteTransportationAttachment(flight.id, attachmentName)
        }
      />
    </DataLine>
  );
