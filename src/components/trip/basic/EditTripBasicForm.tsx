...
export const EditTripBasicForm = ({form}: EditTripBasicFormProps) => {
  ...
  return (<Stack
    ...
    gap="md"
  >
    <TextInput label={t('basic.trip_name', 'Name')} placeholder="Name" mt={"md"} required
    ...
    <TagsInput label={t("basic.trip_destinations", "Destinations",)} required
               key={form.key('destinations')} {...form.getInputProps('destinations')}
               acceptValueOnBlur
               description={t("basic.trip_destinations_description", "Enter the destinations in this trip e.g. San Jose, Guanacaste")}
    ...
    <TagsInput label={t('basic.travellers')}
